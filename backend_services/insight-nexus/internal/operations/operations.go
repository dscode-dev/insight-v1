...
func Capability(name, description string) *operationsv1.Capability {
	return CapabilityEnabled(name, description, true)
}

func CapabilityEnabled(name, description string, enabled bool) *operationsv1.Capability {
	return &operationsv1.Capability{
		Name: name, Version: "v1", Enabled: enabled, Description: description,
	}
}
