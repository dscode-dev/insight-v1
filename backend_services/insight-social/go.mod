module github.com/konoha-labs/insight-social
...
// the workspace. Drop these `replace` lines once:
//   * insight-protos/gen/go is published to a Go module proxy via the
//     v1.0.0 release tag.
//   * insight-runtime-go v1.0.0 is published the same way.
