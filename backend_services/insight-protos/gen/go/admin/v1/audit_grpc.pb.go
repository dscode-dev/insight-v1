...
const (
	AuditService_Append_FullMethodName = "/admin.v1.AuditService/Append"
	AuditService_Query_FullMethodName  = "/admin.v1.AuditService/Query"
)
...
func (c *auditServiceClient) Append(ctx context.Context, in *AppendRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAuditServiceServer) Append(context.Context, *AppendRequest) (*emptypb.Empty, error) {
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.v1.AuditService",
