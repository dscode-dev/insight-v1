...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/data-intelligence/curation", key: "curation", label: "Curation", icon: ClipboardList, permission: "config.read" },
      { href: "/data-intelligence/jobs", key: "explorer-jobs", label: "Collection Jobs", icon: Activity, permission: "config.read" },
      { href: "/data-intelligence/quality", key: "explorer-quality", label: "Data Quality", icon: Gauge, permission: "config.read" },
      { href: "/data-intelligence/runtime", key: "explorer-runtime", label: "Explorer Runtime", icon: ServerCog, permission: "config.read" },
