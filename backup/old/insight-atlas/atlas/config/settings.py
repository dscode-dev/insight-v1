...
class Settings(BaseSettings):
    ...
    # A leitura de diretório SAIU no passo 7. `strength_sync_enabled`,
    # `vector_refresh_enabled` e os intervalos que os acompanhavam
    # governavam dois watchers que varriam o lake do Explorer; os dois
    # foram removidos junto com o código que liam. A partida entra por
    # `atlas.intake` e a memória vetorial é reconstruída por
    # `atlas.vector.builder`, sob demanda.
