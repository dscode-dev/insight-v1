...
Atlas is the platform's only intelligence engine. It must never import
...
FORBIDDEN_ROOTS = {
    "playmaker",        # retired — runtime/streaming absorbed into atlas.*
...
PACKAGE_ROOT = pathlib.Path(__file__).resolve().parents[1] / "atlas"
...
def test_no_legacy_imports_in_atlas() -> None:
    violations: list[str] = []
